...
public static class FoundationCapabilityCatalog
{
    ...
    [
        ...
        D(FoundationCapabilityIds.Idempotency, "Idempotency", CapabilityKind.Optional, CapabilityMaturity.ReferenceOnly, "Reliability", "Provider-neutral reservation/completion/replay contracts with relational EF and HTTP orchestration reference proof.", [FoundationCapabilityIds.WebApi]),
        ...
        D(FoundationCapabilityIds.CliTooling, "FoundationKit CLI", CapabilityKind.Tooling, CapabilityMaturity.ReferenceOnly, "Tooling", "Composer tooling for strict manifest validation, capability/profile discovery, dependency explanation, contract compatibility, deterministic project generation, and the interactive questionnaire; Core Studio reuses the same canonical Composer model, analyzer, and generator for visual composition.", [FoundationCapabilityIds.Kernel]),
        D(FoundationCapabilityIds.WorkbenchTooling, "FoundationKit Workbench", CapabilityKind.Tooling, CapabilityMaturity.ReferenceOnly, "Tooling", "Executable Core architecture and SQL reference consumer with Core Studio surfaces for visual composition, design-system reference, runtime proof, and evidence over the canonical Composer pipeline.", [FoundationCapabilityIds.Kernel])
    ];
