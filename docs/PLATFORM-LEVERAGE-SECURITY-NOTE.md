...
Composer generation was migrated to the same Swashbuckle/OpenAPI.NET generation surface so generated products cannot downgrade the patched dependency floor through their own central package file.
